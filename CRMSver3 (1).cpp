...
void add_Car();
void remove_Car();
void addCustIntoFile(string c_id, string cust_name, string cust_p);
void addCarIntoFile(string car_id, string car_name, int car_rent);
int sorting(int s);
// prototypes end
...
main()
{
  ...
  int cust_id = 0, day, Advance = 0, c_id = 0;
  string cust_name, c_name, c_model;
  string cust_p;
  string car_name, rm_cust;
  int rm_c_id = 0;
...
void add_C()
{
  ...
  cin >> cust_p;
  addCustIntoFile(c_id, cust_name, cust_p);
...
void addCustIntoFile(string c_id, string cust_name, string cust_p)
{
  ...
  fstream FileName;
  FileName.open("customer.txt", ios::out | ios::app);
  if (!FileName)
  {
...
void add_Car()
{
  ...
  cin >> rent;
  addCarIntoFile(id, car, rent);
}

void addCarIntoFile(string car_id, string car_name, int car_rent)
{
  fstream FileName;
  FileName.open("car.txt", ios::out | ios::app);
  if (!FileName)
  {
    cout << "File doesn't exist.";
  }
