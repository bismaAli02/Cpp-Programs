...
void loadEmployeIntoArray()
{
	...
	// Checking Whether the file is empty or not becuase if file is empty then for the first time it takes garbage value
	char temp;
	employe >> temp;
	// if below condition is true then file will not empty
	if (!employe.eof())
	{
		// moving file pointer (cursor) back to begining of file
		employe.seekg(0, ios::beg);
		while (!employe.eof())
		{
			...
			//...............CHeking End of FIle.........to prevent garbage value.........
			if (employe.eof())
				break;
			//................................................................................
